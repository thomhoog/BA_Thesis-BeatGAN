...
def make_generator_model():
    ...
    model.add(layers.Conv2DTranspose(256, (5,5), strides=(2,2), use_bias=False, padding='same'))
    ...
    model.add(layers.Conv2DTranspose(1, (5,5), strides=(1,1), use_bias=True, padding='same', activation='tanh'))
...
opt_dis = tf.keras.optimizers.SGD(0.02)
opt_gen = tf.keras.optimizers.Adam(0.03)
